...
<div class="center">
  <div class="sidebyside" style="text-align:right; display: none;">
...
<!-- This div for view the translated text (English) -->
<div>
  <div class="translate">
    <p id="googletranslate"></p>
                      <div class="translate_control" lang="en" id="gettrans"></div>
                      </div>
</div>
<!-- This div for view the translated text (English) -->
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
<!-- This below Js Script is speechtotext.js file. We include this into these page. -->
...
<script src="//translate.google.com/translate_a/element.js?cb=googleSectionalElementInit&ug=section&hl=en"></script><!-- This is google translate js plugin for translate the text to english -->
<script type="text/javascript" src="responsivevoice.js"></script> <!-- This responsive voice js for speak the translated data -->
<script type="text/javascript">
